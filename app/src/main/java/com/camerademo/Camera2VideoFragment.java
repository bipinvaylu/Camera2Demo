...
//            dequeueAndSaveImage(mRawResultQueue, mYUVImageReader);
//            reader.close();
        }
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            mImageReaderSize = chooseOptimalSize(map.getOutputSizes(ImageReader.class),
                    width, height, mVideoSize);

            mYUVImageReader = ImageReader
                    .newInstance(mImageReaderSize.getWidth()/16, mImageReaderSize.getHeight()/16,
    ...
    private CameraCaptureSession.CaptureCallback getCameraPreviewCallback() {
        return new CameraCaptureSession.CaptureCallback() {
            @Override
            public void onCaptureCompleted(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, @NonNull TotalCaptureResult result) {
                super.onCaptureCompleted(session, request, result);
                Log.d(Camera2VideoFragment.TAG, "Bipin - Capture completed");
